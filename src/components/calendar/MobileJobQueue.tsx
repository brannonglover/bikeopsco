    ...
    <div className="md:hidden space-y-4 flex-shrink-0">
      ...
      <div className="grid gap-3">
        {pendingJobs.length > 0 && (
          ...
          >
            <div className="flex items-center gap-2 px-3.5 py-2.5 bg-amber-600 text-white">
              <span
        ...
        {bookedInJobs.length > 0 && (
          ...
          >
            <div className="flex items-center gap-2 px-3.5 py-2.5 bg-slate-600 text-white">
              <span
