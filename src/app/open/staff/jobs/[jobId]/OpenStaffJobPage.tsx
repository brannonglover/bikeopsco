        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm leading-6 text-slate-600">
              If BikeOps is installed, this will open the job in the app. Otherwise,
              you&apos;ll continue in the web app at {displayUrl}.
            </p>
          </div>
