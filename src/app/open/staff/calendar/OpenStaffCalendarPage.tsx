...
type OpenStaffCalendarPageProps = {
  appUrl: string;
  nativeUrl: string;
  webUrl: string;
};
...
export function OpenStaffCalendarPage({
  appUrl,
  nativeUrl,
  webUrl,
}: OpenStaffCalendarPageProps) {
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm leading-6 text-slate-600">
              If BikeOps is installed, this will open the calendar in the app.
              Otherwise, you&apos;ll continue in the web app at {displayUrl}.
            </p>
          </div>
