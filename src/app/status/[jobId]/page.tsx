        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">
              Choose whether the shop sends status updates and chat message notifications by email, SMS, or both.
            </p>
          </div>
