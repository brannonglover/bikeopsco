...
function LoginLogo() {
  return (
    <div className="mb-5 flex h-40 items-center justify-center sm:h-48">
      <BrandLogo width={800} height={400} className="h-40 w-auto max-w-full object-contain sm:h-48" priority />
    </div>
  );
}
