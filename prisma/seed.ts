...
const DEFAULT_TEMPLATES = [
  ...
  {
    slug: "waitlist_promoted_collection",
    name: "Waitlist Promoted (Collection)",
    subject: "Good news — a spot opened up for your {{bikeMake}} {{bikeModel}}! – {{shopName}}",
    bodyHtml: `<p>Hi {{customerName}},</p><p>Great news — a spot has opened up and we’ve booked in your {{bikeMake}} {{bikeModel}}! You’re off the waitlist.</p><p>We’ll collect your bike at the arranged time and keep you posted as the repair progresses.</p><p style="margin: 20px 0;">{{statusButtonHtml}}</p><p>Thanks,<br/>The {{shopName}} Team</p>`,
    triggerType: "MANUAL",
    stage: null,
    deliveryType: "COLLECTION_SERVICE" as const,
    delayDays: null,
