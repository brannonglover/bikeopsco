...
(function () {
  ...
  function openModal() {
    ...
    overlay.style.cssText =
      "position:fixed;inset:0;z-index:999999;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;" +
    ...
    closeBtn.style.cssText =
      "position:absolute;top:12px;right:12px;z-index:10;width:40px;height:40px;border:none;background:#f1f5f9;" +
      "border-radius:8px;cursor:pointer;display:flex;align-items:center;justify-content:center;" +
      "color:#64748b;transition:color .15s, background .15s;";
